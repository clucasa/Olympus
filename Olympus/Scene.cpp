...
Scene::Scene( ID3D11Device *dev, ID3D11DeviceContext *devcon, Apex* apex, GeometryGenerator *geoGen,
            ...
            mZbuffer(zbuff), mScreenViewport(screenViewport), mAssetManager(assetManager)
{
    ...
    while(getline(fin, lines))
    {
        ...
        else if (lines[0] == 'b') 
        {
            ...
            Object* bowlingPin = new Object(mAssetManager);
...
void Scene::LoadFBX(string filename)
{
    ...
    Object* object = new Object(mAssetManager);
